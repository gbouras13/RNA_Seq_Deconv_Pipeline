...
3. The STAR indices need to be built - a 100 (TCGA) and 150 (EGA) read length index will be created (run on the compute node through slurm):

* TCGA consists of 2x50 paired end reads, EGA is 2x75 paired end reads
